...
export default function page() {
    const almacenes = [
        ...
        { almacen: "ÉXITO SUBA", direccion: "CL. 145 #105B – 58 ( AV. SUBA CON AV. CALI)" },
        { almacen: "ÉXITO NUEVO KENNEDY", direccion: "CARRERA 78K #37 A – 53 SUR" },
        { almacen: "ÉXITO BOSA", direccion: "CL. 65 SUR #78 H – 54" },
        { almacen: "ÉXITO FACATATIVA", direccion: "C. C. EL PÓRTICO, CRA. 5 SUR #13 – 50, FACATATIVÁ" },
        { almacen: "ÉXITO FONTIBON", direccion: "AV. 13 # 106-104 ZONA FRANCA" },
        { almacen: "ÉXITO CIUDAD TUNAL", direccion: "CALLE 47 B SUR # 24 B 33 C. C. CIUDAD TUNAL" },
  ...
  return (
    <>
      ...
      <section className="container mx-auto py-16 px-5">
        <h2 className="text-center text-4xl font-bold -text--dark-green">PUNTOS DE VENTA BOGOTÁ</h2>
        <div className="p-6">
